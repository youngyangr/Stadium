...
function check_pwd1() {
    var code2 = document.getElementById("password1").value;
    var color2 = document.getElementById("password1");
    var reg2 = /.{6,}/;
    if (code2 === "") {
...
function check_username() {
    var code2 = document.getElementById("username1").value;
    var color2 = document.getElementById("username1");
    var reg2 = /^[a-z0-9_-]+$/;
    if (code2 === "") {
        color2.style.border = "1px solid grey";
        return false;
...
function check_pwd2() {
    var code2 = document.getElementById("password1").value;
    var color2 = document.getElementById("password1");
    var code3 = document.getElementById("password2").value;
    var color3 = document.getElementById("password2");
    var reg3 = /.{6,}/;
    if (code3 === "") {
